<template>
	<view class="container no-scroll">
		<!-- #ifndef  H5-->
		<my-nav-bar title="订单支付" @action="navAction" @reSize="reSize" />
		<!-- #endif -->
	...
	export default {
		...
		methods: {
			...
			submitPay() {
				...
				if (this.payWayList[this.payTypeIndex].payType === 4) {
