<template>
	<view>
		...
		<view :class="['content', show ? '' : 'contenthide']">
			<view class="title">
				<view class="close" @click="close()"><image src="http://img.yunjg.net/wxyunjg_img/mall/close.png" /></view>
				<view class="center">请输入支付密码</view>
				<view class="close"></view>
			</view>
			<view class="pay-money">
				<view v-if="payType == 4">金豆</view>
				<view v-if="payType == 3">余额</view>
				<view v-if="payType == 5">合计</view>
			...
			<view class="pay-way" v-if="payType!=5">
				<view>支付方式</view>
				<view class="pay-img" v-if="payType == 3"><image src="http://img.yunjg.net/wxyunjg_img/mall/balance.png"/>余额</view>
				<view class="pay-img" v-if="payType == 4"><image src="http://img.yunjg.net/wxyunjg_img/mall/bean.png"/>金豆</view>
			</view>
		...
		<view :class="['keyboard', show ? '' : 'active', isIphoneX ? 'isIphone' : '']">
			...
			<view class="keyboard-item delte" @tap="del()"><image class="img" src="http://img.yunjg.net/wxyunjg_img/mall/del.png" mode="aspectFill" :lazy-load="true"></image></view>
		</view>
