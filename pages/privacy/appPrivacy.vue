<template>
	<view class="container">
		<view class="dialog bg-white flex justify-center flex-direction align-center" v-if="showDialog">
			<view class="title">服务协议和隐私政策</view>
			<view class="content text-gray-5 text-df margin-bottom-ssm">
			...
			<view class="btn-line flex margin-top margin-bottom-ssm">
				<view class="btn-disagree text-df" @click="disagree">不同意并退出</view>
				<view @click="agree" class="btn-agree text-white bg-theme">同意</view>
			</view>
		</view>
	</view>
</template>
